...
# plt.savefig("C:/Users/brittsc/OneDrive - Universitetet i Oslo/Documents/WRF modeling/Pseudo Global Warming/plot/snow_depth_diff_start_year_"+str(start_year_hist_period)+".png")
# plt.close()
